...
{
    platform_t homePosition = {0, 0, 0, 0, 0, 0};
    return calcServoAngles(homePosition, servo_angles);
}
 ...
 *
 */
int8_t Hexapod_Kinematics::calcServoAnglesOld(platform_t coord, angle_t *servo_angles)
{
    int8_t movOK = 0;
